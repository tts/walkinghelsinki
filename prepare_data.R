...
# Select districts inside Helsinki
...
# crs's has to be the same when st_join'ing
...
url <-"https://opendata.arcgis.com/datasets/ee54ddf0b4db41d69410689394b7c00d_0.geojson"
...
#--------------------------------------------
# Join info on roads and trees by district
#--------------------------------------------
